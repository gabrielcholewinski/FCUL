...
public class FuncoesMonius4 {
     ...
     * @requires n <= sup - inf (para poderem ser todos diferentes)
     */
    public static int[] aleatoriosDiferentes (int n, int inf, int sup, Random g){
     ...
     */
    public static boolean contidoEmParte (int val, int[] v, int parte){
    ...
    /**
     * Distribuir os elementos de um vetor por outros vetores
     * @param vOrigem - O vetor origem
     * @param inicio - Primeiro elemento a copiar
     * @param quantos - Quantos elementos a copiar
     * @return Um vetor com quantos elementos de vOrigem, a partir do elemento
     *         de indice inicio
     * @requires vOrigem != null && inicio >= 0 && quantos + inicio < vOrigem.length
     */
    public static int[] copiaParcial (int[] vOrigem, int inicio, int quantos){
        int[] vDestino = new int[quantos];
        int p = 0;
        for (int i = inicio ; i < inicio + quantos ; i++) {
            vDestino[p] = vOrigem[i];
            p++;
        }
        return vDestino;
    }
    ...
    /***************************************************************************/
    /**** METODOS PARA VERIFICAR SE UMA POSICAO FOI ATINGIDA POR UM MONIUS *****/
    /***************************************************************************/
    ...
    /**
     * Imprime os elementos de um vetor no standard output
     * @param v O vetor
     * @requires v != null
     */
